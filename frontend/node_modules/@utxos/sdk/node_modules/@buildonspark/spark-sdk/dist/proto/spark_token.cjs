...
__export(spark_token_exports, {
  ...
  FinalTokenOutput: () => FinalTokenOutput,
...
var PartialTokenOutput = {
  ...
  fromJSON(object) {
    return {
      ownerPublicKey: isSet3(object.ownerPublicKey) ? bytesFromBase642(object.ownerPublicKey) : new Uint8Array(0),
      withdrawBondSats: isSet3(object.withdrawBondSats) ? globalThis.Number(object.withdrawBondSats) : 0,
      withdrawRelativeBlockLocktime: isSet3(object.withdrawRelativeBlockLocktime) ? globalThis.Number(object.withdrawRelativeBlockLocktime) : 0,
...
function createBaseFinalTokenOutput() {
  return { partialTokenOutput: void 0, revocationCommitment: new Uint8Array(0) };
}
var FinalTokenOutput = {
  encode(message, writer = new import_wire5.BinaryWriter()) {
    if (message.partialTokenOutput !== void 0) {
  ...
  fromJSON(object) {
    return {
      partialTokenOutput: isSet3(object.partialTokenOutput) ? PartialTokenOutput.fromJSON(object.partialTokenOutput) : void 0,
...
var TokenTransaction = {
  encode(message, writer = new import_wire5.BinaryWriter()) {
    ...
    if (message.validityDurationSeconds !== void 0) {
  ...
  fromJSON(object) {
    return {
      ...
      validityDurationSeconds: isSet3(object.validityDurationSeconds) ? globalThis.Number(object.validityDurationSeconds) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var TokenTransactionMetadata = {
  encode(message, writer = new import_wire5.BinaryWriter()) {
    ...
    if (message.clientCreatedTimestamp !== void 0) {
      Timestamp.encode(toTimestamp2(message.clientCreatedTimestamp), writer.uint32(34).fork()).join();
    }
...
function createBasePartialTokenTransaction() {
  return { version: 0, tokenTransactionMetadata: void 0, tokenInputs: void 0, partialTokenOutputs: [] };
}
var PartialTokenTransaction = {
  encode(message, writer = new import_wire5.BinaryWriter()) {
    if (message.version !== 0) {
      writer.uint32(8).uint32(message.version);
    }
    if (message.tokenTransactionMetadata !== void 0) {
  ...
  fromJSON(object) {
    return {
      version: isSet3(object.version) ? globalThis.Number(object.version) : 0,
      tokenTransactionMetadata: isSet3(object.tokenTransactionMetadata) ? TokenTransactionMetadata.fromJSON(object.tokenTransactionMetadata) : void 0,
      tokenInputs: isSet3(object.mintInput) ? { $case: "mintInput", mintInput: TokenMintInput.fromJSON(object.mintInput) } : isSet3(object.transferInput) ? { $case: "transferInput", transferInput: TokenTransferInput.fromJSON(object.transferInput) } : isSet3(object.createInput) ? { $case: "createInput", createInput: TokenCreateInput.fromJSON(object.createInput) } : void 0,
...
function createBaseFinalTokenTransaction() {
  return { version: 0, tokenTransactionMetadata: void 0, tokenInputs: void 0, finalTokenOutputs: [] };
}
var FinalTokenTransaction = {
  encode(message, writer = new import_wire5.BinaryWriter()) {
    if (message.version !== 0) {
      writer.uint32(8).uint32(message.version);
    }
...
var BroadcastTransactionRequest = {
  encode(message, writer = new import_wire5.BinaryWriter()) {
    if (message.identityPublicKey.length !== 0) {
      writer.uint32(10).bytes(message.identityPublicKey);
    }
  ...
  fromJSON(object) {
    return {
      identityPublicKey: isSet3(object.identityPublicKey) ? bytesFromBase642(object.identityPublicKey) : new Uint8Array(0),
      partialTokenTransaction: isSet3(object.partialTokenTransaction) ? PartialTokenTransaction.fromJSON(object.partialTokenTransaction) : void 0,
  ...
  toJSON(message) {
    ...
    if (message.tokenTransactionOwnerSignatures?.length) {
      obj.tokenTransactionOwnerSignatures = message.tokenTransactionOwnerSignatures.map(
        (e) => SignatureWithIndex.toJSON(e)
      );
    }
    return obj;
...
function createBaseBroadcastTransactionResponse() {
  return { finalTokenTransaction: void 0, commitStatus: 0, commitProgress: void 0 };
}
var BroadcastTransactionResponse = {
  ...
  fromJSON(object) {
    return {
      finalTokenTransaction: isSet3(object.finalTokenTransaction) ? FinalTokenTransaction.fromJSON(object.finalTokenTransaction) : void 0,
      commitStatus: isSet3(object.commitStatus) ? commitStatusFromJSON(object.commitStatus) : 0,
      commitProgress: isSet3(object.commitProgress) ? CommitProgress.fromJSON(object.commitProgress) : void 0
    };
  },
