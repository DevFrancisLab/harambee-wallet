...
declare class LightningService {
    ...
    constructor(config: WalletConfigService, connectionManager: ConnectionManager, signingService: SigningService);
    createLightningInvoice({ invoiceCreator, amountSats, memo, receiverIdentityPubkey, descriptionHash, }: CreateLightningInvoiceParams): Promise<LightningReceiveRequest>;
...
declare abstract class SparkWallet extends EventEmitter<SparkWalletEvents> {
     ...
     */
    createLightningInvoice({ amountSats, memo, expirySeconds, includeSparkAddress, receiverIdentityPubkey, descriptionHash, }: CreateLightningInvoiceParams$1): Promise<LightningReceiveRequest>;
    /**
