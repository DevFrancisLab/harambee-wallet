...
declare abstract class SparkWallet extends EventEmitter<SparkWalletEvents> {
     ...
     */
    createHTLC({ receiverSparkAddress, amountSats, preimage, expiryTime, }: CreateHTLCParams): Promise<Transfer>;
...
declare class ConnectionManagerNodeJS extends ConnectionManager {
    ...
    protected createGrpcClient<T>(definition: SparkAuthnServiceDefinition | SparkServiceDefinition | SparkTokenServiceDefinition, channel: Channel, withRetries: boolean, middleware?: ClientMiddleware<RetryOptions$1, {}>, channelKey?: string): Promise<T & {
        close: () => void;
    }>;
    subscribeToEvents(address: string, signal: AbortSignal): Promise<AsyncIterable<SubscribeToEventsResponse>>;
}
...
declare class SparkWalletNodeJS extends SparkWallet {
    protected getTracer(): _opentelemetry_api.Tracer;
...
export { type RawTokenIdentifierHex as $, getNetwork as A, type Bech32mTokenIdentifier as B, type ConfigOptions as C, type DecodedSparkAddressData as D, getNetworkFromAddress as E, getNetworkFromString as F, type Bech32mTokenIdentifierData as G, encodeBech32mTokenIdentifier as H, decodeBech32mTokenIdentifier as I, getNetworkFromBech32mTokenIdentifier as J, type WithdrawParams as K, type LegacySparkAddressFormat as L, type CreateLightningInvoiceParams as M, Network as N, type TransferParams as O, type PayLightningInvoiceParams as P, type TransferWithInvoiceParams as Q, type TransferWithInvoiceOutcome as R, SparkWalletNodeJS as S, type TokenOutputsMap as T, type FulfillSparkInvoiceResponse as U, type TokenInvoice as V, WalletConfigService as W, type InvalidInvoice as X, type GroupSparkInvoicesResult as Y, type DepositParams as Z, type UserTokenMetadata as _, SparkError as a, type TokenMetadataMap as a0, type InitWalletResponse as a1, type SparkWalletProps as a2, type HandlePublicMethodErrorParams as a3, SparkWalletEvent as a4, type SparkWalletEventType as a5, type SparkWalletEvents as a6, type CreateHTLCParams as a7, type SparkErrorContextArg as b, SparkAuthnServiceDefinition as c, type TokenBalanceMap as d, type SparkAddressFormat as e, ConnectionManagerNodeJS as f, ConnectionManager as g, TokenTransactionService as h, WalletConfig as i, type SparkAddressData as j, encodeSparkAddress as k, encodeSparkAddressWithSignature as l, decodeSparkAddress as m, getNetworkFromSparkAddress as n, isLegacySparkAddress as o, isValidSparkAddress as p, isValidPublicKey as q, validateSparkInvoiceSignature as r, assertBech32 as s, toProtoTimestamp as t, bech32mDecode as u, validateSparkInvoiceFields as v, isSafeForNumber as w, type NetworkType as x, NetworkToProto as y, protoToNetwork as z };
