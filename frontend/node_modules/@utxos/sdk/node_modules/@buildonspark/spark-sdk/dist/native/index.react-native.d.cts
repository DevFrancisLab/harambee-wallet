...
import { CallOptions, ClientMiddleware, Metadata, ClientMiddlewareCall } from 'nice-grpc-common';
...
declare class DefaultSparkSigner implements SparkSigner {
    ...
    getNonceForSelfCommitment(selfCommitment: SigningCommitmentWithOptionalNonce): SigningNonce | undefined;
    buildSignFrostParams({ message, keyDerivation, publicKey, verifyingKey, selfCommitment, statechainCommitments, adaptorPubKey, }: SignFrostParams): Promise<SignFrostBindingParams>;
    buildAggregateFrostParams({ message, publicKey, verifyingKey, selfCommitment, statechainCommitments, adaptorPubKey, selfSignature, statechainSignatures, statechainPublicKeys, }: AggregateFrostParams): Promise<AggregateFrostBindingParams>;
...
declare abstract class SparkWallet extends EventEmitter<SparkWalletEvents> {
     ...
     */
    createHTLC({ receiverSparkAddress, amountSats, preimage, expiryTime, }: CreateHTLCParams): Promise<Transfer$1>;
    ...
    createHTLCSenderSpendTx({ htlcTx, hash, hashLockDestinationPubkey, sequenceLockDestinationPubkey, satsPerVbyteFee, }: {
        htlcTx: string;
        hash: string;
    ...
    createHTLCReceiverSpendTx({ htlcTx, hash, hashLockDestinationPubkey, sequenceLockDestinationPubkey, preimage, satsPerVbyteFee, }: {
        htlcTx: string;
        hash: string;
        hashLockDestinationPubkey: string;
        sequenceLockDestinationPubkey: string;
    ...
    queryHTLC({ paymentHashes, status, transferIds, matchRole, limit, offset, }: {
    ...
    protected static handlePublicMethodError(error: unknown, { wallet, traceId }?: HandlePublicMethodErrorParams): Promise<SparkError>;
...
declare class ConnectionManagerBrowser extends ConnectionManager {
    ...
    protected createGrpcClient<T>(definition: SparkAuthnServiceDefinition | SparkServiceDefinition | SparkTokenServiceDefinition, channel: Channel$1, withRetries: boolean, middleware?: ClientMiddleware<RetryOptions$1, {}>, channelKey?: string): Promise<T & {
