...
var TransferStatus = /* @__PURE__ */ ((TransferStatus2) => {
  ...
  TransferStatus2[TransferStatus2["TRANSFER_STATUS_APPLYING_SENDER_KEY_TWEAK"] = 11] = "TRANSFER_STATUS_APPLYING_SENDER_KEY_TWEAK";
...
function transferStatusFromJSON(object) {
  switch (object) {
    ...
    case "TRANSFER_STATUS_APPLYING_SENDER_KEY_TWEAK":
      return 11 /* TRANSFER_STATUS_APPLYING_SENDER_KEY_TWEAK */;
    case -1:
    case "UNRECOGNIZED":
    default:
      return -1 /* UNRECOGNIZED */;
...
function transferStatusToJSON(object) {
  switch (object) {
    ...
    case 11 /* TRANSFER_STATUS_APPLYING_SENDER_KEY_TWEAK */:
...
var TransferType = /* @__PURE__ */ ((TransferType2) => {
  ...
  TransferType2[TransferType2["PRIMARY_SWAP_V3"] = 4] = "PRIMARY_SWAP_V3";
  TransferType2[TransferType2["COUNTER_SWAP_V3"] = 5] = "COUNTER_SWAP_V3";
...
function transferTypeFromJSON(object) {
  switch (object) {
    ...
    case "PRIMARY_SWAP_V3":
      return 4 /* PRIMARY_SWAP_V3 */;
    case 5:
    case "COUNTER_SWAP_V3":
      return 5 /* COUNTER_SWAP_V3 */;
    case -1:
    case "UNRECOGNIZED":
    default:
      return -1 /* UNRECOGNIZED */;
...
function transferTypeToJSON(object) {
  switch (object) {
    ...
    case 40 /* COUNTER_SWAP */:
      return "COUNTER_SWAP";
    case 4 /* PRIMARY_SWAP_V3 */:
      return "PRIMARY_SWAP_V3";
    case 5 /* COUNTER_SWAP_V3 */:
...
function preimageRequestRoleFromJSON(object) {
  switch (object) {
    ...
    case "PREIMAGE_REQUEST_ROLE_RECEIVER":
      return 0 /* PREIMAGE_REQUEST_ROLE_RECEIVER */;
    case 1:
...
function preimageRequestRoleToJSON(object) {
  switch (object) {
    case 0 /* PREIMAGE_REQUEST_ROLE_RECEIVER */:
...
var PreimageRequestWithTransfer = {
  ...
  fromJSON(object) {
    return {
      ...
      senderIdentityPubkey: isSet3(object.senderIdentityPubkey) ? bytesFromBase642(object.senderIdentityPubkey) : new Uint8Array(0)
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    if (message.senderIdentityPubkey.length !== 0) {
      obj.senderIdentityPubkey = base64FromBytes2(message.senderIdentityPubkey);
    }
    return obj;
  },
  create(base) {
...
var QueryHtlcRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      offset: isSet3(object.offset) ? globalThis.Number(object.offset) : 0,
      transferIds: globalThis.Array.isArray(object?.transferIds) ? object.transferIds.map((e) => globalThis.String(e)) : [],
      matchRole: isSet3(object.matchRole) ? preimageRequestRoleFromJSON(object.matchRole) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
0 && (module.exports = {
  ...
  orderFromJSON,
  orderToJSON,
  preimageRequestRoleFromJSON,
  preimageRequestRoleToJSON,
