...
import "./buffer-Cv1Nkx9q.js";
import { Logger, LoggingLevel, Query } from "@lightsparkdev/core";
...
import { Channel, createChannel } from "nice-grpc-web";
import { SpanProcessor } from "@opentelemetry/sdk-trace-base";
import { EventEmitter } from "eventemitter3";
import { TransactionInput, TransactionOutput } from "@scure/btc-signer/psbt";
import { Tracer } from "@opentelemetry/api";
import { Channel as Channel$1 } from "nice-grpc";
import * as nice_grpc_web_lib_client_Transport_js0 from "nice-grpc-web/lib/client/Transport.js";
...
//#endregion
//#region src/proto/google/protobuf/empty.d.ts
/**
...
type DeepPartial$4<T> = T extends Builtin$4 ? T : T extends globalThis.Array<infer U> ? globalThis.Array<DeepPartial$4<U>> : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepPartial$4<U>> : T extends {
  ...
  $case: T["$case"];
} : T extends {} ? { [K in keyof T]?: DeepPartial$4<T[K]> } : Partial<T>;
...
type DeepPartial$3<T> = T extends Builtin$3 ? T : T extends globalThis.Array<infer U> ? globalThis.Array<DeepPartial$3<U>> : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepPartial$3<U>> : T extends {
  ...
  $case: T["$case"];
} : T extends {} ? { [K in keyof T]?: DeepPartial$3<T[K]> } : Partial<T>;
...
interface SubscribeToEventsResponse {
  ...
  /** Include json_name for backwards compatibility for those who are using json serialization. */
  {
    ...
    receiverTransfer: TransferEvent;
  } | {
    $case: "deposit";
...
interface GenerateDepositAddressResponse {
  depositAddress: Address$2 | undefined;
}
 ...
 */
interface RotateStaticDepositAddressRequest {
  /**
...
interface RotateStaticDepositAddressResponse {
  /** The newly generated default deposit address. */
  newDepositAddress: Address$2 | undefined;
  /** The archived (previous default) deposit address. */
  archivedDepositAddress: Address$2 | undefined;
}
/**
...
interface FinalizeDepositTreeCreationRequest {
  /** The identity public key of the user */
  identityPublicKey: Uint8Array;
  /** The on-chain utxo */
  onChainUtxo: UTXO | undefined;
...
interface FinalizeDepositTreeCreationResponse {
...
interface StorePreimageShareV2Request {
  paymentHash: Uint8Array;
...
interface QueryPreimageRequest {
  paymentHash: Uint8Array;
  receiverIdentityPubkey: Uint8Array;
}
interface QueryPreimageResponse {
  preimage?: Uint8Array | undefined;
}
...
declare const Address$2: MessageFns$2<Address$2>;
...
declare const RotateStaticDepositAddressRequest: MessageFns$2<RotateStaticDepositAddressRequest>;
declare const RotateStaticDepositAddressResponse: MessageFns$2<RotateStaticDepositAddressResponse>;
...
declare const FinalizeDepositTreeCreationRequest: MessageFns$2<FinalizeDepositTreeCreationRequest>;
declare const FinalizeDepositTreeCreationResponse: MessageFns$2<FinalizeDepositTreeCreationResponse>;
...
declare const SecretShare: MessageFns$2<SecretShare>;
...
declare const InputSigningData: MessageFns$2<InputSigningData>;
...
declare const ClaimPackage: MessageFns$2<ClaimPackage>;
declare const ClaimTransferRequest: MessageFns$2<ClaimTransferRequest>;
declare const ClaimTransferResponse: MessageFns$2<ClaimTransferResponse>;
...
declare const StorePreimageShareV2Request: MessageFns$2<StorePreimageShareV2Request>;
...
declare const QueryPreimageRequest: MessageFns$2<QueryPreimageRequest>;
declare const QueryPreimageResponse: MessageFns$2<QueryPreimageResponse>;
...
declare const SparkServiceDefinition: {
  ...
  readonly methods: {
    ...
    readonly rotate_static_deposit_address: {
      readonly name: "rotate_static_deposit_address";
      readonly requestType: MessageFns$2<RotateStaticDepositAddressRequest>;
      readonly requestStream: false;
      readonly responseType: MessageFns$2<RotateStaticDepositAddressResponse>;
      readonly responseStream: false;
      readonly options: {};
    };
    ...
    readonly finalize_deposit_tree_creation: {
      readonly name: "finalize_deposit_tree_creation";
      readonly requestType: MessageFns$2<FinalizeDepositTreeCreationRequest>;
      readonly requestStream: false;
      readonly responseType: MessageFns$2<FinalizeDepositTreeCreationResponse>;
      readonly responseStream: false;
      readonly options: {};
    };
    ...
    readonly store_preimage_share_v2: {
      readonly name: "store_preimage_share_v2";
      readonly requestType: MessageFns$2<StorePreimageShareV2Request>;
      readonly requestStream: false;
      readonly responseType: MessageFns$4<Empty>;
      readonly responseStream: false;
      readonly options: {};
    ...
    readonly query_preimage: {
      readonly name: "query_preimage";
      readonly requestType: MessageFns$2<QueryPreimageRequest>;
      readonly requestStream: false;
      readonly responseType: MessageFns$2<QueryPreimageResponse>;
      readonly responseStream: false;
      readonly options: {};
    };
    readonly query_htlc: {
    ...
    readonly claim_transfer: {
      readonly name: "claim_transfer";
      readonly requestType: MessageFns$2<ClaimTransferRequest>;
      readonly requestStream: false;
      readonly responseType: MessageFns$2<ClaimTransferResponse>;
      readonly responseStream: false;
      readonly options: {};
    };
...
interface SparkServiceClient<CallOptionsExt = {}> {
  ...
  /** Archives the current default static deposit address and generates a new one for the user. */
  rotate_static_deposit_address(request: DeepPartial$2<RotateStaticDepositAddressRequest>, options?: CallOptions & CallOptionsExt): Promise<RotateStaticDepositAddressResponse>;
  ...
  /** Creates a deposit tree with the commitments from get_signing_commitments, after they are signed. Fails if the tree already exists. */
  finalize_deposit_tree_creation(request: DeepPartial$2<FinalizeDepositTreeCreationRequest>, options?: CallOptions & CallOptionsExt): Promise<FinalizeDepositTreeCreationResponse>;
  ...
  store_preimage_share_v2(request: DeepPartial$2<StorePreimageShareV2Request>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /**
   * Gets a specified number of signing commmitments for a set of nodes, which can be used as
   * part of a transfer package.
   */
  ...
  /** Used to check if a user has provided the preimage for a HODL invoice in lightning receive flow. */
  query_preimage(request: DeepPartial$2<QueryPreimageRequest>, options?: CallOptions & CallOptionsExt): Promise<QueryPreimageResponse>;
  ...
  claim_transfer(request: DeepPartial$2<ClaimTransferRequest>, options?: CallOptions & CallOptionsExt): Promise<ClaimTransferResponse>;
...
type DeepPartial$2<T> = T extends Builtin$2 ? T : T extends globalThis.Array<infer U> ? globalThis.Array<DeepPartial$2<U>> : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepPartial$2<U>> : T extends {
  ...
  $case: T["$case"];
} : T extends {} ? { [K in keyof T]?: DeepPartial$2<T[K]> } : Partial<T>;
...
//#endregion
//#region src/graphql/objects/BitcoinNetwork.d.ts
...
//#endregion
//#region src/spark-bindings/types.d.ts
...
//#endregion
//#region src/spark-bindings/spark-bindings.d.ts
type WasmVerifiableSecretShare = {
  threshold: number;
  index: number;
  share: Uint8Array;
  proofs: Uint8Array[];
};
declare abstract class SparkFrostBase {
  abstract signFrost(params: SignFrostBindingParams): Promise<Uint8Array>;
  abstract aggregateFrost(params: AggregateFrostBindingParams): Promise<Uint8Array>;
  abstract createDummyTx(address: string, amountSats: bigint): Promise<DummyTx>;
  abstract encryptEcies(msg: Uint8Array, publicKey: Uint8Array): Promise<Uint8Array>;
  abstract decryptEcies(encryptedMsg: Uint8Array, privateKey: Uint8Array): Promise<Uint8Array>;
  generateAdaptorFromSignature(signature: Uint8Array): {
    adaptorSignature: Uint8Array;
    adaptorPrivateKey: Uint8Array;
  };
  generateSignatureFromExistingAdaptor(signature: Uint8Array, adaptorPrivateKeyBytes: Uint8Array): Uint8Array;
  validateAdaptorSignature(pubkey: Uint8Array, hash: Uint8Array, signature: Uint8Array, adaptorPubkey: Uint8Array): boolean;
  applyAdaptorToSignature(pubkey: Uint8Array, hash: Uint8Array, signature: Uint8Array, adaptorPrivateKeyBytes: Uint8Array): Uint8Array;
  abstract splitSecretWithProofs(secret: Uint8Array, threshold: number, numShares: number): Promise<WasmVerifiableSecretShare[]>;
  abstract recoverSecret(shares: {
    threshold: number;
    index: number;
    share: Uint8Array;
  }[]): Promise<Uint8Array>;
  abstract validateShare(share: Uint8Array, index: number, threshold: number, proofs: Uint8Array[]): Promise<void>;
...
//#endregion
//#region src/utils/secret-sharing.d.ts
type VerifiableSecretShare = WasmVerifiableSecretShare;
declare function splitSecretWithProofs(secret: Uint8Array, threshold: number, numberOfShares: number): Promise<VerifiableSecretShare[]>;
declare function recoverSecret(shares: VerifiableSecretShare[]): Promise<Uint8Array>;
declare function validateShare(share: VerifiableSecretShare): Promise<void>;
//#endregion
...
type SubtractSplitAndEncryptParams = Omit<SplitSecretWithProofsParams, "secret"> & {
  first: KeyDerivation;
...
interface SparkSigner {
  ...
  getDepositSigningKey(): Promise<Uint8Array>;
  getNonceForSelfCommitment(selfCommitment: SigningCommitmentWithOptionalNonce): SigningNonce | undefined;
  ...
  subtractSplitAndEncrypt(params: SubtractSplitAndEncryptParams): Promise<SubtractSplitAndEncryptResult>;
...
//#endregion
//#region src/graphql/objects/ClaimStaticDepositStatus.d.ts
...
//#endregion
//#region src/graphql/objects/CurrencyUnit.d.ts
/** This enum identifies the unit of currency associated with a CurrencyAmount. **/
declare enum CurrencyUnit$1 {
  /**
   * This is an enum value that represents values that could be added in the future.
   * Clients should support unknown values as more of them could be added without notice.
   */
...
//#endregion
//#region src/graphql/objects/CurrencyAmount.d.ts
/** This object represents the value and unit for an amount of currency. **/
interface CurrencyAmount {
  /** The original numeric value for this CurrencyAmount. **/
  originalValue: number;
  /** The original unit of currency for this CurrencyAmount. **/
  originalUnit: CurrencyUnit$1;
}
//#endregion
//#region src/graphql/objects/ClaimStaticDeposit.d.ts
...
//#endregion
//#region src/graphql/objects/ExitSpeed.d.ts
...
//#endregion
//#region src/graphql/objects/SparkCoopExitRequestStatus.d.ts
...
//#endregion
//#region src/graphql/objects/Leaf.d.ts
interface Leaf {
...
//#endregion
//#region src/graphql/objects/PageInfo.d.ts
...
//#endregion
//#region src/graphql/objects/SparkTransferToLeavesConnection.d.ts
...
//#endregion
//#region src/graphql/objects/Transfer.d.ts
declare class Transfer {
  ...
  constructor(/** The total amount of the transfer. **/

  totalAmount: CurrencyAmount,
  /** The id of the transfer known at signing operators. If not set, the transfer hasn't been
   * initialized. **/

  sparkId?: string | undefined, /** The user request this transfer belongs to, if there is any **/
...
//#endregion
//#region src/graphql/objects/CoopExitRequest.d.ts
...
//#endregion
//#region src/graphql/objects/SparkLeavesSwapRequestStatus.d.ts
...
//#endregion
//#region src/graphql/objects/SwapLeaf.d.ts
interface SwapLeaf {
  leafId: string;
...
//#endregion
//#region src/graphql/objects/LeavesSwapRequest.d.ts
...
//#endregion
//#region src/graphql/objects/Invoice.d.ts
interface Invoice {
...
//#endregion
//#region src/graphql/objects/LightningReceiveRequestStatus.d.ts
...
//#endregion
//#region src/graphql/objects/LightningReceiveRequest.d.ts
...
//#endregion
//#region src/graphql/objects/LightningSendRequestStatus.d.ts
...
//#endregion
//#region src/graphql/objects/LightningSendRequest.d.ts
...
//#endregion
//#region src/types/sdk-types.d.ts
...
//#endregion
//#region src/graphql/objects/ClaimStaticDepositOutput.d.ts
interface ClaimStaticDepositOutput {
  transferId: string;
}
//#endregion
//#region src/graphql/objects/CompleteCoopExitInput.d.ts
interface CompleteCoopExitInput {
  userOutboundTransferExternalId: string;
  coopExitRequestId?: string | undefined;
}
//#endregion
//#region src/graphql/objects/CoopExitFeeEstimate.d.ts
interface CoopExitFeeEstimate {
  userFee: CurrencyAmount;
  l1BroadcastFee: CurrencyAmount;
}
//#endregion
//#region src/graphql/objects/CoopExitFeeEstimatesInput.d.ts
interface CoopExitFeeEstimatesInput {
  leafExternalIds: string[];
  withdrawalAddress: string;
}
//#endregion
//#region src/graphql/objects/CoopExitFeeEstimatesOutput.d.ts
...
//#endregion
//#region src/graphql/objects/CoopExitFeeQuote.d.ts
...
//#endregion
//#region src/graphql/objects/CoopExitFeeQuoteInput.d.ts
interface CoopExitFeeQuoteInput {
  leafExternalIds: string[];
  withdrawalAddress: string;
}
//#endregion
//#region src/graphql/objects/GetChallengeOutput.d.ts
interface GetChallengeOutput {
  protectedChallenge: string;
}
//#endregion
//#region src/graphql/objects/LeavesSwapFeeEstimateOutput.d.ts
interface LeavesSwapFeeEstimateOutput {
  feeEstimate: CurrencyAmount;
}
//#endregion
//#region src/graphql/objects/LightningSendFeeEstimateInput.d.ts
...
//#endregion
//#region src/graphql/objects/LightningSendFeeEstimateOutput.d.ts
interface LightningSendFeeEstimateOutput {
  feeEstimate: CurrencyAmount;
}
//#endregion
//#region src/graphql/objects/RequestCoopExitInput.d.ts
...
//#endregion
//#region src/graphql/objects/RequestLightningReceiveInput.d.ts
...
//#endregion
//#region src/graphql/objects/RequestLightningSendInput.d.ts
...
//#endregion
//#region src/graphql/objects/UserLeafInput.d.ts
...
//#endregion
//#region src/graphql/objects/RequestSwapInput.d.ts
...
//#endregion
//#region src/graphql/objects/SparkUserRequestStatus.d.ts
...
//#endregion
//#region src/graphql/objects/SparkUserRequestType.d.ts
...
//#endregion
//#region src/graphql/objects/UserRequest.d.ts
...
//#endregion
//#region src/graphql/objects/SparkWalletUserToUserRequestsConnection.d.ts
...
//#endregion
//#region src/graphql/objects/StaticDepositQuoteInput.d.ts
...
//#endregion
//#region src/graphql/objects/StaticDepositQuoteOutput.d.ts
...
//#endregion
//#region src/graphql/objects/VerifyChallengeOutput.d.ts
...
type BrowserOrNodeJSChannel = Channel$1 | Channel;
...
declare abstract class ConnectionManager {
  ...
  protected abstract createChannelWithTLS(address: Address$1, isStreamClientType?: boolean): Promise<Channel$1 | Channel>;
  protected abstract createGrpcClient<T>(definition: SparkAuthnServiceDefinition | SparkServiceDefinition | SparkTokenServiceDefinition, channel: Channel$1 | Channel, withRetries: boolean, middleware?: ClientMiddleware<RetryOptions, {}>, channelKey?: ChannelKey): Promise<T & {
    close?: () => void;
  }>;
  private config;
  private timeSync;
...
declare class TransferService extends BaseTransferService {
  constructor(config: WalletConfigService, connectionManager: ConnectionManager, signingService: SigningService);
  claimTransferCore(transfer: Transfer$1): Promise<TreeNode[]>;
  ...
  claimTransfer(transfer: Transfer$1): Promise<TreeNode[]>;
}
//#endregion
...
declare abstract class SparkWallet extends EventEmitter<SparkWalletEvents> {
  ...
  createHTLC({
    ...
    preimage,
    expiryTime
  }: CreateHTLCParams): Promise<Transfer$1>;
   ...
   * @returns {Promise<Transfer>} The HTLC transfer details
   */
  claimHTLC(preimage: string): Promise<Transfer$1>;
...
//#endregion
//#region src/services/connection/connection.browser.d.ts
...
declare class ConnectionManagerBrowser extends ConnectionManager {
  ...
  constructor(config: WalletConfigService, authMode?: AuthMode, transport?: nice_grpc_web_lib_client_Transport_js0.Transport);
  protected getMonotonicTime(): number;
  protected prepareMetadata(metadata: Metadata): Metadata;
...
declare abstract class SparkReadonlyClient {
  ...
  getTransfersByIds(transferIds: string[]): Promise<Transfer$1[]>;
  /** Queries pending inbound transfers for a spark address. */
  getPendingTransfers(sparkAddress: string): Promise<Transfer$1[]>;
...
//#endregion
//#region src/spark-readonly-client/spark-readonly-client.react-native.d.ts
declare class SparkReadonlyClientReactNative extends SparkReadonlyClient {
  protected buildConnectionManager(config: WalletConfigService, authMode: AuthMode): ConnectionManagerBrowser;
}
//#endregion
//#region src/spark-wallet/spark-wallet.react-native.d.ts
...
//#endregion
export { type AggregateFrostParams, AuthenticationError, type ConnectionManager as BaseConnectionManager, Bech32mTokenIdentifier, Bech32mTokenIdentifierData, BroadcastConfig, BroadcastResult, type ConfigOptions, ConfigurationError, ConnectionManagerBrowser as ConnectionManager, CreateHTLCParams, CreateLightningHodlInvoiceParams, CreateLightningInvoiceParams, DEFAULT_FEE_SATS, DIRECT_HTLC_TIMELOCK_OFFSET, DIRECT_TIMELOCK_OFFSET, DecodedSparkAddressData, DefaultSparkSigner, DepositParams, type DerivedHDKey, type DummyTx, FeeBumpTxChain, FeeBumpTxPackage, FeeRate, FulfillSparkInvoiceResponse, type GetUtxosParams, GroupSparkInvoicesResult, HTLC_TIMELOCK_OFFSET, HandlePublicMethodErrorParams, Hasher, type IKeyPackage, INITIAL_SEQUENCE, IdempotencyOptions, InitWalletResponse, InternalValidationError, InvalidInvoice, type KeyDerivation, type KeyDerivationType, type KeyPair, LOGGER_NAMES, LeafInfo, LegacySparkAddressFormat, LoggerName, Network, NetworkError, NetworkToProto, NetworkType, OperatorSpecificTokenTransactionSignablePayload, PayLightningInvoiceParams, type QueryDepositAddressesParams, type QuerySparkInvoicesParams, type QueryTokenTransactionsParams, type QueryTransfersParams, RPCError, RawTokenIdentifierHex, type SignFrostParams, type SigningCommitment, type SigningCommitmentWithOptionalNonce, type SigningNonce, SparkAddressData, SparkAddressFormat, SparkAuthenticationError, SparkError, SparkErrorContextArg, SparkReadonlyClientReactNative as SparkReadonlyClient, SparkRequestError, SparkSdkError, SparkSdkLogger, type SparkSigner, SparkValidationError, SparkWalletReactNative as SparkWallet, SparkWalletEvent, SparkWalletEventType, SparkWalletEvents, SparkWalletProps, type SplitSecretWithProofsParams, type SubtractSplitAndEncryptParams, type SubtractSplitAndEncryptResult, TEST_UNILATERAL_DIRECT_SEQUENCE, TEST_UNILATERAL_SEQUENCE, TIME_LOCK_INTERVAL, TokenBalanceMap, TokenInvoice, TokenMetadataMap, type TokenOutputLock, TokenOutputsMap, TokenTransactionService, TransferParams, TransferWithInvoiceOutcome, TransferWithInvoiceParams, TxChain, UnsafeStatelessSparkSigner, UserTokenMetadata, Utxo, ValidationError, VerifiableSecretShare, WalletConfig, type WalletConfigService, WithdrawParams, ZERO_SEQUENCE, addPrivateKeys, addPublicKeys, applyAdaptorToSignature, applyAdditiveTweakToPublicKey, assertBech32, bech32mDecode, checkIfValidSequence, collectResponses, computeTaprootKeyNoScript, constructFeeBumpTx, constructUnilateralExitFeeBumpPackages, createConnectorRefundTxs, createCurrentTimelockRefundTxs, createDecrementedTimelockNodeTx, createDecrementedTimelockRefundTxs, createInitialTimelockNodeTx, createInitialTimelockRefundTxs, createMultiInputRootTx, createRootNodeTx, createSigningCommitment, createSigningNonce, createTestUnilateralRefundTxs, createTestUnilateralTimelockNodeTx, createZeroTimelockNodeTx, decodeBech32mTokenIdentifier, decodeBytesToSigningCommitment, decodeBytesToSigningNonce, decodeSparkAddress, doesLeafNeedRefresh, doesTxnNeedRenewed, encodeBech32mTokenIdentifier, encodeSigningCommitmentToBytes, encodeSigningNonceToBytes, encodeSparkAddress, encodeSparkAddressWithSignature, filterTokenBalanceForTokenIdentifier, generateAdaptorFromSignature, generateSignatureFromExistingAdaptor, getClaimPackageSigningPayload, getCurrentTimelock, getEphemeralAnchorOutput, getLatestDepositTxId, getNetwork, getNetworkFromAddress, getNetworkFromBech32mTokenIdentifier, getNetworkFromSparkAddress, getNetworkFromString, getNextHTLCTransactionSequence, getNextTransactionSequence, getP2TRAddressFromPkScript, getP2TRAddressFromPublicKey, getP2TRScriptFromPublicKey, getP2WPKHAddressFromPublicKey, getRandomSigningNonce, getSigHashFromMultiInputTx, getSigHashFromTx, getSigningCommitmentFromNonce, getSparkAddressFromTaproot, getSparkFrost, getTransactionSequence, getTransferPackageSigningPayload, getTxEstimatedVbytesSizeByNumberOfInputsOutputs, getTxFromRawTxBytes, getTxFromRawTxHex, getTxId, getTxIdNoReverse, hash160, hashFinalTokenTransaction, hashOperatorSpecificTokenTransactionSignablePayload, hashPartialTokenTransaction, hashTokenTransaction, hashTokenTransactionV1, hashTokenTransactionV2, hashTokenTransactionV3, isEphemeralAnchorOutput, isLegacySparkAddress, isSafeForNumber, isTxBroadcast, isValidPublicKey, isValidSparkAddress, isZeroTimelock, lastKeyWithTarget, maybeApplyFee, newHasher, optionsWithIdempotencyKey, proofOfPossessionMessageHashForDepositAddress, protoToNetwork, recoverSecret, sortInvoiceAttachments, splitSecretWithProofs, subtractPrivateKeys, subtractPublicKeys, sumOfPrivateKeys, sumTokenOutputs, toProtoTimestamp, validateOutboundAdaptorSignature, validateShare, validateSparkInvoiceFields, validateSparkInvoiceSignature };