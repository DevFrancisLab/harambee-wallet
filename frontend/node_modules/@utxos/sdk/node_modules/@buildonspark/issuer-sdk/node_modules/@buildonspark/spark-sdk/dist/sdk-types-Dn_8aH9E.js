import { Network, TransferStatus, TransferType } from "./proto/spark.js";
import { bytesToHex } from "@noble/curves/utils";
import { LightsparkException, isObject } from "@lightsparkdev/core";
...
let CurrencyUnit$1 = /* @__PURE__ */ function(CurrencyUnit) {
	/**
	* This is an enum value that represents values that could be added in the future.
	* Clients should support unknown values as more of them could be added without notice.
	*/
...
const CurrencyAmountFromJson = (obj) => {
	return {
		...
		originalUnit: CurrencyUnit$1[obj["currency_amount_original_unit"]] ?? CurrencyUnit$1.FUTURE_VALUE
	};
};
...
`,
		variables: { id },
		constructObject: (data) => isObject(data) && "entity" in data && isObject(data.entity) ? CoopExitFeeQuoteFromJson(data.entity) : null
	};
};
...
`,
		variables: { id },
		constructObject: (data) => isObject(data) && "entity" in data && isObject(data.entity) ? UserRequestFromJson(data.entity) : null
	};
};
...
//#endregion
export { FRAGMENT$6 as A, getLeavesSwapRequestQuery as C, SparkLeavesSwapRequestStatus as D, TransferFromJson as E, CurrencyAmountFromJson as F, CurrencyUnit$1 as I, ClaimStaticDepositStatus as L, ClaimStaticDepositRequestType as M, ClaimStaticDepositFromJson as N, ExitSpeed as O, getClaimStaticDepositQuery as P, BitcoinNetwork as R, LeavesSwapRequestFromJson as S, Transfer as T, FRAGMENT$3 as _, mapTreeNodeToWalletLeaf as a, LightningReceiveRequestStatus as b, FRAGMENT$1 as c, SparkUserRequestStatus as d, SparkCoopExitRequestStatus as f, LightningSendRequestStatus as g, getLightningSendRequestQuery as h, mapTransferToWalletTransfer as i, getCoopExitFeeQuoteQuery as j, CoopExitFeeQuoteFromJson as k, getUserRequestQuery as l, LightningSendRequestFromJson as m, mapSettingsProtoToWalletSettings as n, SparkWalletUser as o, FRAGMENT$2 as p, mapTransferLeafToWalletTransferLeaf as r, SparkWalletUserToUserRequestsConnectionFromJson as s, TransferDirection as t, SparkUserRequestType as u, LightningReceiveRequestFromJson as v, FRAGMENT$5 as w, FRAGMENT$4 as x, getLightningReceiveRequestQuery as y };