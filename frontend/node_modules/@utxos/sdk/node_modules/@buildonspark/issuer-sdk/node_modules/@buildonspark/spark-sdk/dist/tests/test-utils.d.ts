import { Nt as ConfigOptions } from "../spark-readonly-client-BneG-nP1.js";
import "../common-XbHXNiic.js";
import { QueryTransfersResponse, Transfer, TreeNode } from "../proto/spark.js";
import { Ft as SparkSigner, Pt as DefaultSparkSigner } from "../client-ePmrlT_d.js";
import { r as SparkWalletNodeJS } from "../spark-readonly-client.node-BV-jgAxa.js";
import "../index.node.js";
import { Transaction } from "@scure/btc-signer";
import { TransactionInput, TransactionOutput } from "@scure/btc-signer/psbt";

//#region src/tests/utils/test-faucet.d.ts
type FaucetCoin = {
  key: Uint8Array;
...
declare class BitcoinFaucet {
  ...
  getNewExternalWPKHWallet(): Promise<{
    address: string;
    key: Uint8Array;
    pubKey: Uint8Array;
  }>;
  ...
  waitForMempoolEntry(txid: string, timeoutMs?: number, intervalMs?: number): Promise<any>;
}
//#endregion
//#region src/tests/utils/spark-testing-wallet.d.ts
...
//#endregion
//#region src/tests/test-utils.d.ts
