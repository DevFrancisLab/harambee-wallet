import { Network, SigningKeyshare, Transfer as Transfer$1, TransferLeaf, TransferStatus, TransferType, TreeNode, WalletSetting } from "./proto/spark.js";
...
//#endregion
//#region src/graphql/objects/ClaimStaticDepositRequestType.d.ts
...
//#endregion
//#region src/graphql/objects/ClaimStaticDepositInput.d.ts
...
//#endregion
//#region src/graphql/objects/CompleteCoopExitOutput.d.ts
interface CompleteCoopExitOutput {
  requestId: string;
}
//#endregion
//#region src/graphql/objects/CompleteLeavesSwapOutput.d.ts
interface CompleteLeavesSwapOutput {
  requestId: string;
}
//#endregion
//#region src/graphql/objects/CompleteSeedReleaseInput.d.ts
interface CompleteSeedReleaseInput {
  phoneNumber: string;
  code: string;
}
//#endregion
//#region src/graphql/objects/CompleteSeedReleaseOutput.d.ts
interface CompleteSeedReleaseOutput {
  seed: string;
}
//#endregion
//#region src/graphql/objects/Connection.d.ts
...
//#endregion
//#region src/graphql/objects/CoopExitFeeQuoteOutput.d.ts
interface CoopExitFeeQuoteOutput {
  quoteId: string;
}
//#endregion
//#region src/graphql/objects/Entity.d.ts
...
//#endregion
//#region src/graphql/objects/GetChallengeInput.d.ts
...
//#endregion
//#region src/graphql/objects/LeavesSwapFeeEstimateInput.d.ts
...
//#endregion
//#region src/graphql/objects/NotifyReceiverTransferInput.d.ts
interface NotifyReceiverTransferInput {
  phoneNumber: string;
  amountSats: number;
}
//#endregion
//#region src/graphql/objects/Provider.d.ts
interface Provider {
  accountId: string;
  jwt: string;
}
...
//#endregion
//#region src/graphql/objects/RequestCoopExitOutput.d.ts
...
//#endregion
//#region src/graphql/objects/RequestLightningReceiveOutput.d.ts
...
//#endregion
//#region src/graphql/objects/RequestLightningSendOutput.d.ts
...
//#endregion
//#region src/graphql/objects/RequestSwapOutput.d.ts
...
//#endregion
//#region src/graphql/objects/SparkWalletUser.d.ts
declare class SparkWalletUser implements Entity {
  ...
  id: string, /** The date and time when the entity was first created. **/

  createdAt: string, /** The date and time when the entity was last updated. **/

  updatedAt: string, /** The identity public key of the user. **/

  identityPublicKey: string, /** The typename of the object **/
...
//#endregion
//#region src/graphql/objects/StartSeedReleaseInput.d.ts
...
//#endregion
//#region src/graphql/objects/VerifyChallengeInput.d.ts
...
//#endregion
//#region src/graphql/objects/WalletUserIdentityPublicKeyInput.d.ts
interface WalletUserIdentityPublicKeyInput {
  phoneNumber: string;
}
//#endregion
//#region src/graphql/objects/WalletUserIdentityPublicKeyOutput.d.ts
...
//#endregion
export { ClaimStaticDepositOutput as $, WasmVerifiableSecretShare as $t, NotifyReceiverTransferInput as A, getClaimStaticDepositQuery as At, CoopExitFeeQuote as B, KeyDerivationType as Bt, RequestLightningSendOutput as C, Transfer as Ct, RequestCoopExitOutput as D, SparkCoopExitRequestStatus as Dt, RequestLightningReceiveInput as E, Leaf as Et, GetChallengeOutput as F, SparkSigner as Ft, Connection as G, SigningNonce as Gt, CoopExitFeeEstimatesOutput as H, SignFrostParams as Ht, GetChallengeInput as I, UnsafeStatelessSparkSigner as It, CompleteLeavesSwapOutput as J, SubtractSplitAndEncryptResult as Jt, CompleteSeedReleaseOutput as K, SplitSecretWithProofsParams as Kt, Entity as L, AggregateFrostParams as Lt, LightningSendFeeEstimateInput as M, CurrencyUnit$1 as Mt, LeavesSwapFeeEstimateOutput as N, ClaimStaticDepositStatus as Nt, RequestCoopExitInput as O, ExitSpeed as Ot, LeavesSwapFeeEstimateInput as P, DefaultSparkSigner as Pt, ClaimStaticDepositRequestType as Q, validateShare as Qt, CoopExitFeeQuoteOutput as R, DerivedHDKey as Rt, UserLeafInput as S, getCoopExitRequestQuery as St, RequestLightningReceiveOutput as T, PageInfo as Tt, CoopExitFeeEstimatesInput as U, SigningCommitment as Ut, getCoopExitFeeQuoteQuery as V, KeyPair as Vt, CoopExitFeeEstimate as W, SigningCommitmentWithOptionalNonce as Wt, CompleteCoopExitInput as X, recoverSecret as Xt, CompleteCoopExitOutput as Y, VerifiableSecretShare as Yt, ClaimStaticDepositInput as Z, splitSecretWithProofs as Zt, getUserRequestQuery as _, LeavesSwapRequest as _t, SspClientOptions as a, WalletTransferLeaf as at, RequestSwapOutput as b, SparkLeavesSwapRequestStatus as bt, WalletUserIdentityPublicKeyInput as c, mapTransferToWalletTransfer as ct, StaticDepositQuoteOutput as d, getLightningSendRequestQuery as dt, getSparkFrost as en, TransferDirection as et, StaticDepositQuoteInput as f, LightningSendRequestStatus as ft, UserRequest as g, Invoice as gt, SparkWalletUserToUserRequestsConnection as h, LightningReceiveRequestStatus as ht, SspClient as i, WalletTransfer as it, LightningSendFeeEstimateOutput as j, CurrencyAmount as jt, Provider as k, ClaimStaticDeposit as kt, VerifyChallengeOutput as l, mapTreeNodeToWalletLeaf as lt, SparkWalletUser as m, getLightningReceiveRequestQuery as mt, HasSspClientOptions as n, IKeyPackage as nn, WalletLeaf as nt, TransferWithUserRequest as o, mapSettingsProtoToWalletSettings as ot, StartSeedReleaseInput as p, LightningReceiveRequest as pt, CompleteSeedReleaseInput as q, SubtractSplitAndEncryptParams as qt, MayHaveSspClientOptions as r, BitcoinNetwork as rn, WalletSettings as rt, WalletUserIdentityPublicKeyOutput as s, mapTransferLeafToWalletTransferLeaf as st, GetUserRequestsParams as t, DummyTx as tn, UserRequestType as tt, VerifyChallengeInput as u, LightningSendRequest as ut, SparkUserRequestType as v, getLeavesSwapRequestQuery as vt, RequestLightningSendInput as w, SparkTransferToLeavesConnection as wt, RequestSwapInput as x, CoopExitRequest as xt, SparkUserRequestStatus as y, SwapLeaf as yt, CoopExitFeeQuoteInput as z, KeyDerivation as zt };